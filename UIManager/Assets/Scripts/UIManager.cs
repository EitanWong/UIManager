...
using UIFrameWork.FX;
namespace UIFrameWork
{
    public static class UIManager
    {
        public const string CanvasName= "UI";//Canvas的名称（所有创建的UI面板都会存放在这Canvas下面）
        /// <summary>
        /// 显示UI面板
        /// </summary>
        ...
        /// <param name="UpdateTime">淡入效果更新时间</param>
        /// <param name="Speed">更新速度</param>
        /// <param name="CallBack">更新完毕回调</param>
        public static void FadeInFX(GameObject Panel,float UpdateTime,float Speed,Action CallBack)
        {
            UIFX._S.FadeInFX(Panel, UpdateTime, Speed, CallBack);
        }
        /// <summary>
        /// 淡入UI面板
        /// </summary>
        ...
        /// <param name="UpdateTime">淡入效果更新时间</param>
        /// <param name="Speed">更新速度</param>
        public static void FadeInFX(GameObject Panel, float UpdateTime, float Speed)
        {
            UIFX._S.FadeInFX(Panel, UpdateTime, Speed, null);
        }
        /// <summary>
        /// 淡出UI面板
        /// </summary>
        ...
        /// <param name="Speed">更新速度</param>
        /// <param name="CallBack">更新完毕回调</param>
        public static void FadeOutFX(GameObject Panel, float UpdateTime, float Speed, Action CallBack)
        {
            UIFX._S.FadeOutFX(Panel, UpdateTime, Speed, CallBack);
        }
        /// <summary>
        /// 淡出UI面板
        /// </summary>
        ...
        /// <param name="UpdateTime">淡入效果更新时间</param>
        /// <param name="Speed">更新速度</param>
        public static void FadeOutFX(GameObject Panel, float UpdateTime, float Speed)
        {
            UIFX._S.FadeOutFX(Panel, UpdateTime, Speed, null);
        }
    }
